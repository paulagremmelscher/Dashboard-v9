...
export default function App() {
  ...
  const leadsMetrics = [
    ...
    {id:'waMvd',      label:'WA Montevideo',    value:formatNumber(mWAMvd26),  sub:`${selMonth}`,  pct:null,
     series: yearSeries(d2026.waMvd, d2025.waMvd)},
    {id:'waPdE',      label:'WA Punta del Este',value:formatNumber(mWAPdE26),  sub:`${selMonth}`,  pct:null,
     series: yearSeries(d2026.waPdE, d2025.waPdE)},
    {id:'instagram',  label:'Instagram DMs',    value:formatNumber(mIG26),     sub:`${prevMonth}: ${formatNumber(gv(d2025.leadsIG,prevMonth,'real'))}`,     pct:growthPct(mIG26,gv(d2025.leadsIG,prevMonth,'real')),
     series: yearSeries(d2026.leadsIG?.map(d=>({mes:d.mes,valor:d.real})), d2025.leadsIG?.map(d=>({mes:d.mes,valor:d.real})))},
